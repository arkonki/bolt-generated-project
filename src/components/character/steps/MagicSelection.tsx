...
export function MagicSelection() {
  ...
  const { tricks, spells, loading, error: spellsError } = useMagicSpells(character.magicSchool);
  ...
  const filteredSpells = spells.filter(spell => {
    ...
    if (filter === 'school') return spell.school_id === character.magicSchool;
    ...
    updateCharacter({
      spells: {
        general: [...selectedTricks, ...selectedSpells.filter(spell => 
          spells.find(s => s.name === spell)?.school === null
        )],
        school: {
          name: selectedSchool,
          spells: selectedSpells.filter(spell => 
            spells.find(s => s.name === spell)?.school === character.magicSchool
          )
        }
      }
    });
